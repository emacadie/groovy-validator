...
<p>You must append the "f" at the end of the number. If you set "throwException" to true for {@link info.shelfunit.properties.annotations.AnnotationProcessor} or {@link info.shelfunit.properties.annotations.ImmutableValidator} and an exception is thrown, the "f" will not be printed as part of the number in the message.</p>
